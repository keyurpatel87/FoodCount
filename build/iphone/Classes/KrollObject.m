 ...
 * Copyright (c) 2009-2011 by FoodCount, Inc. All Rights Reserved.
...
//@interface FoodCountObject : NSObject
//@end

@interface FoodCountObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FoodCountObject class]])
		{
			for (NSString *key in [[(FoodCountObject*)o modules] allKeys])
			{
