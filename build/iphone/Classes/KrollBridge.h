...
@interface FoodCountObject : KrollCoverageObject {
#else
@interface FoodCountObject : KrollObject {
#endif
@private
...
extern NSString * FoodCount$ModuleRequireFormat;
