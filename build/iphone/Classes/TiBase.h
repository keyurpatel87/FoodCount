...
// in simulator we redefine to format for FoodCount Developer console
...
{\
	NSString * exceptionName = [@"org.foodcount." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.foodcount";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFoodCountNativeItemNone = -1, 
	UIFoodCountNativeItemSpinner = -2,
	UIFoodCountNativeItemProgressBar = -3,
	
	UIFoodCountNativeItemSlider = -4,
	UIFoodCountNativeItemSwitch = -5,
	UIFoodCountNativeItemMultiButton = -6,
	UIFoodCountNativeItemSegmented = -7,
	
	UIFoodCountNativeItemTextView = -8,
	UIFoodCountNativeItemTextField = -9,
	UIFoodCountNativeItemSearchBar = -10,
	
	UIFoodCountNativeItemPicker = -11,
	UIFoodCountNativeItemDatePicker = -12,
	
	UIFoodCountNativeItemInfoLight = -13,
	UIFoodCountNativeItemInfoDark = -14,
	
	UIFoodCountNativeItemDisclosure = -15,
	
	UIFoodCountNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FoodCount instances of
