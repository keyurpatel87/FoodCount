...
/**
 Base class for all FoodCount views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FoodCount view hierarchy (such as wrapped iOS UIViews) was touched.
